...
export const CasesPage = () => {
  ...
  return (
    <section className="space-y-6">
      ...
      <form onSubmit={onSubmit} className="grid grid-cols-5 gap-4 rounded-xl border border-[#E2E8F0] bg-white p-4 shadow-sm">
        ...
        <button className="col-span-5 rounded-lg bg-[#2463eb] px-4 py-2 text-white font-semibold hover:bg-[#1d4fd8]" type="submit">
          Dosya Oluştur
        </button>
      </form>
