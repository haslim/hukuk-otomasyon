...
echo "=== SIMPLE MENU RESTORATION ===\n";
echo "Restoring menu system with step-by-step approach...\n\n";
...
try {
    ...
    // Step 3: Create main menu items one by one
    echo "\nStep 3: Creating main menu items...\n";
    $mainMenuItems = [
    ...
    foreach ($mainMenuItems as $item) {
        try {
            ...
            echo "ERROR creating {$item['label']}: " . $e->getMessage() . "\n";
            throw $e;
        }
    }

    // Step 4: Create sub-menu items
    echo "\nStep 4: Creating Arabuluculuk sub-menu items...\n";
    ...
    foreach ($mediationSubItems as $item) {
        try {
            ...
            echo "ERROR creating sub-menu {$item['label']}: " . $e->getMessage() . "\n";
            throw $e;
        }
    }
    ...
    // Step 6: Create permissions for administrator
    echo "\nStep 6: Creating administrator permissions...\n";
    foreach ($createdMenuItems as $menuItem) {
        try {
            ...
            echo "ERROR creating admin permission for {$menuItem->label}: " . $e->getMessage() . "\n";
            throw $e;
        }
    }
    echo "✓ Administrator permissions created\n";

    // Step 7: Create permissions for lawyer
    echo "\nStep 7: Creating lawyer permissions...\n";
    $visibleForLawyer = [
        '/', // Dashboard
        '/cases', // Dosyalar
    ...
    foreach ($createdMenuItems as $path => $menuItem) {
        try {
            ...
            echo "ERROR creating lawyer permission for {$menuItem->label}: " . $e->getMessage() . "\n";
            throw $e;
        }
    }
    ...
    echo "\n✓ Simple menu restoration completed successfully!\n";
